...
describe('compare editions — the per-track judge', () => {
  ...
  it('the summary states exact counts and the differing runtimes before any click', () => {
    ...
    assert.match(s.matchingSentence, /^Acquires 11 of 12 songs, as songs, pinned to the edition you picked/)
    assert.match(s.matchingSentence, /already-owned recordings are skipped/)
