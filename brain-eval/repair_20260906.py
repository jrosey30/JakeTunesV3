...
Writes: /tmp/mood-index.candidate-20260906.bin + repair_20260906_ids.json
...
CAND = "/tmp/mood-index.candidate-20260906.bin"
FRESH_CUTOFF = "2026-09-06T05:55"  # tonight's trainer (launchd, clean 06:00:04Z-06:08:04Z)
...
def main():
    ...
    json.dump({"repaired": [i for i, _ in suspects], "pruned_orphans": orphans,
              ...
              open(os.path.join(HERE, "repair_20260906_ids.json"), "w"), indent=1)
