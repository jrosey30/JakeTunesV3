...
eo = set(emb) - lib_ids
print(f"embeddings: vectors={len(emb)} orphans={len(eo)} (watch: was 152 on 09-08)")
...
print(f"enrichment: {enriched}/{len(tracks)} backlog={len(tracks)-enriched} (series 315->458->542->564->?)")
