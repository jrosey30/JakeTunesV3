"""rt_20260911 — router-truth on tonight's snapshot, current indexes only.
Extends the production series (09-04 0.818 -> 09-05 0.816 -> 09-06 0.811 -> 09-08 0.808 -> 09-09 0.805 -> 09-10 0.819).
