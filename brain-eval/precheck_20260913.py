...
os.environ.setdefault("JT_STATE_DIR", "/tmp/brain-snap-20260913")
import run_eval as R

SNAP = "/tmp/brain-snap-20260913"
...
print(f"enrichment: {enriched}/{len(tracks)} backlog={len(tracks)-enriched} (series 315->458->542->564->533->532->485->?)")
