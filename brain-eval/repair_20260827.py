#!/usr/bin/env python3
"""repair_20260827 — 7th re-run of the 08-18 mood-index repair after the
...
Writes: /tmp/mood-index.candidate-20260827.bin + repair_20260827_ids.json
Never touches the NAS. Apply is a separate, gated step.
"""
import json, os, struct, sys, time
sys.path.insert(0, "/tmp/brain-eval-worktree/brain-eval")
os.environ.setdefault("JT_STATE_DIR", "/tmp/brain-snap-20260827")
import numpy as np
import run_eval as R
import urllib.request

HERE = "/tmp/brain-eval-worktree/brain-eval"
SNAP = "/tmp/brain-snap-20260827"
CAND = "/tmp/mood-index.candidate-20260827.bin"
FRESH_CUTOFF = "2026-08-27T07:10"  # tonight's trainer run (UTC; clean finish 06:01Z)
...
def main():
    ...
    json.dump({"repaired": [i for i, _ in suspects], "pruned_orphans": orphans,
              ...
              open(os.path.join(HERE, "repair_20260827_ids.json"), "w"), indent=1)
