#!/usr/bin/env python3
"""repair_20260901 — completes the 7th-clobber repair that the aborted 08-27 session never ran of the 08-18 mood-index repair after the
...
Writes: /tmp/mood-index.candidate-20260901.bin + repair_20260901_ids.json
...
FRESH_CUTOFF = "2026-09-01T05:55"  # tonight's trainer (launchd, clean 06:00:06Z-06:01:45Z)
...
def main():
    ...
    json.dump({"repaired": [i for i, _ in suspects], "pruned_orphans": orphans,
              ...
              open(os.path.join(HERE, "repair_20260901_ids.json"), "w"), indent=1)
