"""exp_20260919_sag_decomp — READ-ONLY decomposition of the wave sag.

rt series: ... -> 09-09 0.805 -> 09-10 0.819 -> 09-11 0.819 -> 09-12 0.816 -> 09-13 0.816 -> 09-14 0.813 -> 09-15 0.813 -> 09-17 0.813 -> 09-18 0.806 (backlog 150->104). ELEVENTH data point; drain night 3: expect unenriched cohort ~100.
...
os.environ.setdefault("JT_STATE_DIR", "/tmp/brain-snap-20260919")
import numpy as np
import run_eval as R
import diag_ret011_012 as D

SNAP = "/tmp/brain-snap-20260919"
