...
eo = set(emb) - lib_ids
print(f"embeddings: vectors={len(emb)} orphans={len(eo)} (watch: 152 steady through 09-16)")
...
print(f"enrichment: {enriched}/{len(tracks)} backlog={len(tracks)-enriched} (series ...398->348->298->248->200->150->?)")
