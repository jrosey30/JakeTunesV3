#!/usr/bin/env python3
"""repair_20260823 — 4th re-run of the 08-18 mood-index repair after the
...
Writes: /tmp/mood-index.candidate-20260823.bin + repair_20260823_ids.json
...
HERE = "/tmp/brain-eval-20260823/brain-eval"
SNAP = "/tmp/brain-snap-20260823"
CAND = "/tmp/mood-index.candidate-20260823.bin"
FRESH_CUTOFF = "2026-08-23T05:55"  # tonight's trainer run (UTC)
...
def main():
    ...
    json.dump({"repaired": [i for i, _ in suspects], "pruned_orphans": orphans,
              ...
              open(os.path.join(HERE, "repair_20260823_ids.json"), "w"), indent=1)
