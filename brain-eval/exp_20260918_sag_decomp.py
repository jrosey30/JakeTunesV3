"""exp_20260918_sag_decomp — READ-ONLY decomposition of the wave sag.

rt series: ... -> 09-09 0.805 -> 09-10 0.819 -> 09-11 0.819 -> 09-12 0.816 -> 09-13 0.816 -> 09-14 0.813 -> 09-15 0.813 -> 09-16 0.813 (backlog 298->248). NINTH data point; stale-215 drain night 1 check: expect unenriched cohort ~198 for the orphan component.
...
os.environ.setdefault("JT_STATE_DIR", "/tmp/brain-snap-20260918")
import numpy as np
import run_eval as R
import diag_ret011_012 as D

SNAP = "/tmp/brain-snap-20260918"
