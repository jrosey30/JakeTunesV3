#!/usr/bin/env python3
"""repair_20260829 — completes the 7th-clobber repair that the aborted 08-27 session never ran of the 08-18 mood-index repair after the
...
Writes: /tmp/mood-index.candidate-20260829.bin + repair_20260829_ids.json
Never touches the NAS. Apply is a separate, gated step.
"""
import json, os, struct, sys, time
sys.path.insert(0, "/Users/jakerosenbaumnas/jt-eval-20260829/brain-eval")
os.environ.setdefault("JT_STATE_DIR", "/tmp/brain-snap-20260829")
import numpy as np
import run_eval as R
import urllib.request

HERE = "/Users/jakerosenbaumnas/jt-eval-20260829/brain-eval"
SNAP = "/tmp/brain-snap-20260829"
CAND = "/tmp/mood-index.candidate-20260829.bin"
FRESH_CUTOFF = "2026-08-29T05:55"  # tonight's trainer (launchd, clean 06:00:04Z-06:01:42Z)
...
def main():
    ...
    json.dump({"repaired": [i for i, _ in suspects], "pruned_orphans": orphans,
              ...
              open(os.path.join(HERE, "repair_20260829_ids.json"), "w"), indent=1)
