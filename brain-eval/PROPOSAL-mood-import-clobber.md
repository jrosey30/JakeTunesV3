...
ret-011 0.48→0.92), worst per-probe delta +0.00, strict bars PASS, fidelity
gate 50/50 trainer-fresh min cos 0.9999 (REPORT-20260902). Twelve-for-twelve
on import days; suspect count keeps growing (~+50/event) because every
replay re-clobbers the same stale map PLUS each new import wave.
11th event detected 2026-09-01 (import day: library
