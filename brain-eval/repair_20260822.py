#!/usr/bin/env python3
"""repair_20260822 — re-run of the 08-18 mood-index repair after the
...
Writes: /tmp/mood-index.candidate-20260822.bin + repair_20260822_ids.json
...
HERE = "/tmp/jt-brain-eval-0822/brain-eval"
SNAP = "/tmp/brain-snap-20260822"
CAND = "/tmp/mood-index.candidate-20260822.bin"
FRESH_CUTOFF = "2026-08-22T05:55"  # tonight's trainer run (UTC)
...
def main():
    ...
    json.dump({"repaired": [i for i, _ in suspects], "pruned_orphans": orphans,
              ...
              open(os.path.join(HERE, "repair_20260822_ids.json"), "w"), indent=1)
